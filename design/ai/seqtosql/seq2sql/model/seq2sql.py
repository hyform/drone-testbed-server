...
from .aggregation_predictor import AggregationPredictor
from .selection_predictor import SelectionClausePredictor
from .condition_predictor import ConditionPredictor
from ....seqtosql.library.table import Table
from ....seqtosql.library.query import Query
...
class Seq2SQL(nn.Module):
    ...
    def save_readable_results(self, predicted_query, table_ids, table_data):
        result = ''
        for index in range(len(predicted_query)):
            ...
            result = table.query_str(predicted_query_object)
        return result
